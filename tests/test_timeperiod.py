...
class TestTimeperiods(unittest.TestCase):
    ...
    def test_create_timeperiods_scheduling_timeline_actions(self):
        ...
        res = my_account.Timeperiods.create_timeperiods_scheduling_timeline_actions(
            self.project_pk
        )
        self.assertEqual(res["status"], 200)
    ...
    def test_get_timeperiods_scheduling_timeline_actions(self):
        ...
        res = my_account.Timeperiods.get_timeperiods_scheduling_timeline_actions(
            self.project_pk
        )
        self.assertEqual(res["status"], 200)
    ...
    def test_get_user_period_details(self):
        ...
        user_period_pk = self.testHelper._create_user_period_return_pk(
            self.orguser_pk, self.team_pk, self.project_pk
        )
