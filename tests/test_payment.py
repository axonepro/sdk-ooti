...
class TestPayments(unittest.TestCase):
    ...
    def test_create_payment(self):
        ...
        res_creation_item = my_account.Invoices.create_invoice_item(
    ...
    def test_update_amount_payment_invoice(self):
        ...
        invoice_payment_pk = my_account.Payments.get_payment_details(self.payment_pk)[
            "data"
        ]["invoice_payments"][0]["pk"]
        res_update_amount_invoice = my_account.Payments.update_payment_invoice(
            invoice_payment_pk, update
        )
