...
class TestInvoices(unittest.TestCase):
    ...
    def setUp(cls):
        ...
        cls.invoice_pk = testHelper._create_invoice_return_pk(
            cls.team_pk, cls.project_pk
        )
        cls.invoice_item_pk = testHelper._create_invoice_item_return_pk(cls.invoice_pk)
        cls.payment_pk = testHelper._create_payment_return_pk(
            cls.team_pk, cls.invoice_pk, cls.currency_pk
        )

        cls.invoice_pk_not_validated = testHelper._create_invoice_return_pk(
            cls.team_pk, cls.project_pk
        )
        cls.invoice_item_pk_not_validated = testHelper._create_invoice_item_return_pk(
            cls.invoice_pk_not_validated
        )
    ...
    def test_update_invoice(self):
        ...
        res_update = my_account.Invoices.update_invoice(
            self.invoice_pk_not_validated, invoice_updated
        )
    ...
    def test_validate_invoice(self):
        ...
        res_validate = my_account.Invoices.validate_invoice(
            self.invoice_pk_not_validated
        )
    ...
    def test_create_invoice_item(self):
        ...
        res_creation = my_account.Invoices.create_invoice_item(
            self.invoice_pk, invoice_item
        )  # Invoice cannot be changed once valid
    ...
    def test_update_invoice_item(self):
        ...
        res_update = my_account.Invoices.update_invoice_item(
            self.invoice_item_pk_not_validated, update
        )
        self.assertEqual(res_update["status"], 200)
    ...
    def test_delete_invoice_item(self):
        ...
        res_delete = my_account.Invoices.delete_invoice_item(
            self.invoice_item_pk
        )  # Invoice cannot be changed once valid
