...
class Jobs(Helper):
    ...
    def get_jobs_invoices_items_list(self, page=1):
        ...
        route = "v1/jobs/invoices/items/list/{0}/?page_size={1}&page={2}".format(
    ...
    def get_jobs_invoices_list(self, page=1):
        ...
        route = "v1/jobs/invoices/list/{0}/?page_size={1}&page={2}".format(
            self.org_pk, self.pagination, page
        )
        response = self.process_request(
            requests, "GET", self.base_url, route, self.headers, None, None
    ...
    def get_jobs_list(self, page=1):
        ...
        route = "v1/jobs/list/{0}/?page_size={1}&page={2}".format(
            self.org_pk, self.pagination, page
        )
        response = self.process_request(
            requests, "GET", self.base_url, route, self.headers, None, None
    ...
    def get_jobs_months_list(self, page=1):
        ...
        route = "v1/jobs/month/list/{0}/?page_size={1}&page={2}".format(
            self.org_pk, self.pagination, page
        )
        response = self.process_request(
            requests, "GET", self.base_url, route, self.headers, None, None
