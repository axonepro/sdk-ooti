...
class Invoices(Helper):
    ...
    def get_invoices_list(self, page=1):
        ...
        route = "v1/invoices/list/{0}/?page_size={1}&page={2}".format(
    ...
    def get_invoice_items(self, pk, page=1):
        ...
        route = "v1/invoices/items/{0}/?page_size={1}&page={2}".format(
            pk, self.pagination, page
        )
        response = self.process_request(
            requests, "GET", self.base_url, route, self.headers, None, None
        )
    ...
    def get_credit_notes_list(self, page=1):
        ...
        route = "v1/invoices/list/{0}/?page_size={1}&page={2}&type=9".format(
            self.org_pk, self.pagination, page
        )
        response = self.process_request(
            requests, "GET", self.base_url, route, self.headers, None, None
