...
class Defaults(Helper):
    ...
    def get_defaults_phase_team_list(self, team_pk, page=1):
        ...
        route = (
            "v1/defaults/defaults/phases/list/{0}/{1}/?page_size={2}&page={3}".format(
    ...
    def get_defaults_phasesets_org_list(self, page=1):
        ...
        route = (
            "v1/defaults/defaults/phasesets/list/{0}/?page_size={1}&page={2}".format(
                self.org_pk, self.pagination, page
            )
        )
        response = self.process_request(
    ...
    def create_defaults_phasesets_team(self, team_pk, data):
        ...
        route = "v1/defaults/defaults/phasesets/list/{0}/{1}/".format(
            self.org_pk, team_pk
        )
        response = self.process_request(
            requests, "POST", self.base_url, route, self.headers, None, json.dumps(data)
    ...
    def get_defaults_plans_org_list(self, page=1):
        ...
        route = "v1/defaults/defaults/plans/list/{0}/?page_size={1}&page={2}".format(
            self.org_pk, self.pagination, page
        )
        response = self.process_request(
            requests, "GET", self.base_url, route, self.headers, None, None
    ...
    def get_defaults_plans_team_list(self, team_pk, page=1):
        ...
        route = (
            "v1/defaults/defaults/plans/list/{0}/{1}/?page_size={1}&page={2}".format(
                self.org_pk, team_pk, self.pagination, page
            )
        )
        response = self.process_request(
    ...
    def get_defaults_plansets_team_list(self, team_pk, page=1):
        ...
        route = (
            "v1/defaults/defaults/plansets/list/{0}/{1}/?page_size={2}&page={3}".format(
                self.org_pk, team_pk, self.pagination, page
            )
        )
        response = self.process_request(
    ...
    def create_defaults_plansets_team(self, team_pk, data):
        ...
        route = "v1/defaults/defaults/plansets/list/{0}/{1}/".format(
            self.org_pk, team_pk
        )
        response = self.process_request(
            requests, "POST", self.base_url, route, self.headers, None, json.dumps(data)
