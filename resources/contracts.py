...
class Contracts(Helper):
    ...
    def get_contractors_list(self, page=1):
        ...
        route = "v1/contracts/contractor/list/{0}/?page_size={1}&page={2}".format(
    ...
    def generate_contracts_org(self, project_pk):
        ...
        route = "v1/contracts/generate/{0}/?project_pk={1}".format(
            self.org_pk, project_pk
        )
        response = self.process_request(
            requests, "POST", self.base_url, route, self.headers, None, None
        )
    ...
    def get_contracts_items_list(self, page=1):
        ...
        route = "v1/contracts/item/list/{0}/?page_size={1}&page={2}".format(
            self.org_pk, self.pagination, page
        )
        response = self.process_request(
            requests, "GET", self.base_url, route, self.headers, None, None
    ...
    def get_contracts_list(self, page=1):
        ...
        route = "v1/contracts/list/{0}/?page_size={1}&page={2}".format(
            self.org_pk, self.pagination, page
        )
        response = self.process_request(
            requests, "GET", self.base_url, route, self.headers, None, None
    ...
    def get_contracts_month_list(self, page=1):
        ...
        route = "v1/contracts/month/list/{0}/?page_size={1}&page={2}".format(
            self.org_pk, self.pagination, page
        )
        response = self.process_request(
            requests, "GET", self.base_url, route, self.headers, None, None
