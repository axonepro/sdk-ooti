...
class Posts(Helper):
    ...
    def get_posts_albums_list(self, page=1):
        ...
        route = "v1/posts/album/list/{0}/?page_size={1}&page={2}".format(
    ...
    def get_posts_images_list(self, page=1):
        ...
        route = "v1/posts/image/list/{0}/?page_size={1}&page={2}".format(
            self.org_pk, self.pagination, page
        )
        response = self.process_request(
            requests, "GET", self.base_url, route, self.headers, None, None
    ...
    def get_posts_likes_list(self, page=1):
        ...
        route = "v1/posts/like/list/{0}/?page_size={1}&page={2}".format(
            self.org_pk, self.pagination, page
        )
        response = self.process_request(
            requests, "GET", self.base_url, route, self.headers, None, None
    ...
    def get_posts_list(self, page=1):
        ...
        route = "v1/posts/list/{0}/?page_size={1}&page={2}".format(
            self.org_pk, self.pagination, page
        )
        response = self.process_request(
            requests, "GET", self.base_url, route, self.headers, None, None
