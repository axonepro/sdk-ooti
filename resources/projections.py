...
class Projections(Helper):
    ...
    def get_projections_month_annexes_list(self, project_id, page=1):
        ...
        route = "v1/projections/months/annex/list/{0}/?page_size={1}&page={2}".format(
            project_id, self.pagination, page
        )
        response = self.process_request(
            requests, "GET", self.base_url, route, self.headers, None, None
        )
    ...
    def get_projections_month_fees_list(self, project_id, page=1):
        ...
        route = "v1/projections/months/fee/list/{0}/?page_size={1}&page={2}".format(
            project_id, self.pagination, page
        )
        response = self.process_request(
            requests, "GET", self.base_url, route, self.headers, None, None
    ...
    def get_projections_month_phases_list(self, project_id, page=1):
        ...
        route = "v1/projections/months/phase/list/{0}/?page_size={1}&page={2}".format(
            project_id, self.pagination, page
        )
        response = self.process_request(
            requests, "GET", self.base_url, route, self.headers, None, None
    ...
    def get_projections_roles_annex_list(self, project_pk, page=1):
        ...
        project_pk -- pk of the project
        """
        route = "v1/projections/roles/annex/list/{0}/?page_size={1}&page={2}".format(
    ...
    def get_projections_roles_phase_list(self, project_pk, page=1):
        ...
        project_pk -- pk of the project
        """
        route = "v1/projections/roles/phase/list/{0}/?page_size={1}&page={2}".format(
            project_pk, self.pagination, page
        )
        response = self.process_request(
            requests, "GET", self.base_url, route, self.headers, None, None
    ...
    def get_projections_users_annex_list(self, project_pk, page=1):
        ...
        project_pk -- pk of the project
        """
        route = "v1/projections/users/annex/list/{0}/?page_size={1}&page={2}".format(
            project_pk, self.pagination, page
        )
        response = self.process_request(
            requests, "GET", self.base_url, route, self.headers, None, None
    ...
    def get_projections_users_phase_list(self, project_pk, page=1):
        ...
        project_pk -- pk of the project
        """
        route = "v1/projections/users/phase/list/{0}/?page_size={1}&page={2}".format(
            project_pk, self.pagination, page
        )
        response = self.process_request(
            requests, "GET", self.base_url, route, self.headers, None, None
