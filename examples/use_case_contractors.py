...
if __name__ == "__main__":
    ...
    data = {'phase':fee_phase_dict[fee_phase_name],
            'progress':40,
            'date':'19-04-2022'}
    data2 = {'phase':fee_phase_dict[fee_phase_name2],
            'progress':25,
            'date':'19-04-2022'}
    ...
    #Create the bill
    my_account.Invoices.create_invoice(team_pk,{'project':project_id,'invoice_date':"20-05-2022"})